...
/**
 * This class is used to parse an earthquake JSON respons.
 * It is used to get an arrayList of earthquake objects.
 */
...
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> getEarthquakes(String urlString) {
        ...
        // Make a HTTPRequest to get jsonData
        String jsonResponse = "";
        try {
        ...
        // Create {@link Earthquake} objects parsing the jsonResponse;
    ...
    /**
     * Helper method to connect to USGS web-site and get a jsonResponse
     *
     * @param queryURL represents the query to USGS web-site
     * @return jsonResponse represents the respons got
     * @throws IOException
     */
    ...
    /**
     * Tries to create an URL object form a string
     *
     * @param urlString string representation of an URL
     * @return queryURL that represents query to USGS web-site
     */
    private static URL createURL(String urlString) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error: Malformed URL.");
        }
    ...
    private static ArrayList<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            // Features is a JSONARRAY
            JSONArray jEarthquakes = root.getJSONArray("features");

            // Create earthquake object using info from earthquake in jEarthquakes
            for (int i = 0; i < jEarthquakes.length(); i++) {
                // jEarthquakes holds JSONobjects
                JSONObject jEarthquake = jEarthquakes.getJSONObject(i);

                // Get earthquake properties for jEarthquake
                // properties is a JSONobject
                JSONObject jEarthquakeProp = jEarthquake.getJSONObject("properties");

                // Create and add earthquake object using info from jEarthquakeProp
                Double magnitude = jEarthquakeProp.getDouble("mag");
                String place = jEarthquakeProp.getString("place");
                Long time = jEarthquakeProp.getLong("time");
                String detailsUrl = jEarthquakeProp.getString("url");

                earthquakes.add(new Earthquake(magnitude, place, time, detailsUrl));
    ...
    /**
     * Return default list of earthquakes, when there is no internet
     */
    public static ArrayList<Earthquake> getDefaultEarthquakes() {
